...
람다식(Lambda Expression)
	:객체 지향에서는 메소드를 사용하기 위해서 반드시 클래스를 정의한 후 메소드를 선언해야한다
	이러한 불편함 떄문에 최근 함수형 프로그래밍(Functional Programming )의 장점이 
	대두되었고, 이런 단점을 보안하기 위해  JDK1.8부터 지원하게되었다.
 */
interface IKosmo3{
...
public class Ex03Lambda {
	...
	public static void main(String[] args) {
		...
		-함수명도 생략한다. 부모에서 오버라이딩 하므로 유추할 수 있다.
		- 매개뵨슝허 {} 사이에 ->(화살표)를 삽입하여 완성한다.
		 */
		...
		/*
		 ...
		 -매개변수의 타입을 예상할 수 있으면 생략가능
		 -메개변수가 하나라면 소괄호 생략가능
		 -실행문이 하나고, 동시에 return문이 아니라면 중괄호도 생략가능
		 */

...
/*
 Function<T,E>
 	: 매개변수와 리턴값을 둘다 가지고 있는  apply()메소드를 가지고 있음
 ...
 */
	public static void main(String[] args) {
		...
		System.out.println("Lambda 문자열길이 ="+func.apply("Lambda"));//6
		System.out.println("LambdaExpression문자열길이="
				+ func.apply("LambdaExpression"));//16
		System.out.println("===============================");
		...
		/*
		 Human 객체를 매개변수로 받아서 해당객체의 점수를 반환하는 람다식
		 */
		Function<Human, Integer> getFunctoin = (Human h) ->{
			return h.getScore();//Human객체의 score값 반환
		};
		int score = getFunctoin.apply(p1);

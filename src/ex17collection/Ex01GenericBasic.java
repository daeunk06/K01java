...
//과일상자: Object기반으로 모든객체(과일)을 저장할 수 있는 클래스.
class FruitBox{
	Object item;
...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 OramgeBox에 Orange객체를 생성한 후 저장하고  출력함. 
		 */
		...
		/*
		 ...
		 -> 즉, 자료형에는 안전하나 구현에는 불편함이 있다.
		 다른객체를 저장하기 위해 또 다른 Box클래스를 생성해야한다.
		 */

		/*oBox1.store("당도가 20인 오렌지");//<-컴파일 에러발생
		Orange orange2 = oBox1.pullOut(); 여기 두문장 실행안된다.
		orange2.showInfo();*/
		
		/*
		 Object를 기반으로 한 FruitBox는 구현에는 편리하나 코드레벨에서
		 컴파일에러가 발생하지 않으므로, 오류를 찾아내기 훨씬 어려다.

...
자료형에 해당하는 부분을 타입매개변수 T(Type)로 교체하고 객체생성시 자료형을
...
public class Ex02GenericClass {
	public static void main(String[] args) {
		...
		GenericFruitBox<Banana> bananaBox =
					new GenericFruitBox<Banana>();
		bananaBox.store(new Banana(20));
		Banana banana =  bananaBox.pullOut();
		banana.showInfo();
		
		/*
		 OrangeBox는 인스턴스 생성시 Orange를 저장 할 수 있는 용도로 생성되기에
		 다른 객체는 저장불가. 아래 코드에서 컴파일 에러가 발생하므로 자료형에도 안전한
		 코드가된다.
		 */

...
/*
 ...
 생성된 배열은 Heap힙 영역에 저장되고, 할당된 메모리의 주소값을
 반환한다. 그래서 배일명(배열변수)은 주소값(참조값)을 할당받는다.
  해당주소를 통해 배열에 접근한다.
 */
 ...
 * 위해 일반적으로 반복문 사용
 * 배열명.length 해당배열의 크기를 반환한다. 배열의 크기가
 * 변경되더라도 유연하게 사용가능.
 */
		...
		System.out.println("배열명(numArr)=" + numArr);//30출력
		System.out.println("numArr 2번방의 값:=" + numArr[2]);//배열명(numArr)=[I@15db9742
		...
		/*
		 객체배열
		 	: 기본자료형을 저장하는 배열이 아니라. 객체의 참조값을 저장할 용도로
		 	생성하는 배열이다. 사용법 동일.
		 */
		...
		/*
		 ...
		 갯수를 통해 크기를 정할 수 있으므로 이런경우 크기는 생략하도록 약속함
		 */

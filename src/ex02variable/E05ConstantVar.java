...
public class E05ConstantVar {
	...
	public static void main(String[] args) {
		/*
		 상수: 지정된 값이 변하지 않는 메모리의 한 종류
		 선언방법 : final 자료형 변수명 = 초기값;
		 - 상수는 딱 한번만 초기화 되고 중간에 값을 변경하면 에러발생 
		 -선언시 전체를 대문자로 선언하고 , 연결되는 단어가 있는 경우 -언더바 사용
		...
		//System.out.println("우리는" + NICK_NAME); 상수가 초기화 되지 않은 상태에서 출력하면 에러가 발생.
		NICK_NAME = " 코스모71기";// 이게 상수 초기화한거임
		System.out.println("우리는" + NICK_NAME);
		
		/*
		 *가위바위 보 게임을 제작하기 위해 개발자는 아래와 같이 결정하였다.
		 *가위: 1 바위:2 보: 3
		 */
		final int SCISSOR = 1;
		final int ROCK = 2;
		...
		/*
		 *PAPPER와 같은 단어는 누가 보더라도 이해할수 있으므로 가독성이 높은 명시적인 코드가 된다.
		 */
		computer = SCISSOR;
		user = PAPER;

...
/*
 String 타입 : 참조형변수로써 기본자료형이 아님
 			   문자열을 저장하루 수있는 자료형으로 실제로는 class임.
 			   자바에서는 문자열을 표현할때 "으로 감싸면 되고, 연결할 때 + 기호를 사용한다.
 */
		...
		/*
		 *String은 클래스 이므로 new키워드를 이용해서 인스턴트(객체)를 생성한 후 문자열을 참조한다.
		 */
		...
		/*
		 * 믄자열+숫자 => 우선순위가 없다면 일반적으로 문자열로 출력된다. 단, 산술연산의 결과를 출력하고 싶다면
		  	아래와같이 소괄호를 이용해 우선순위에대한 변화를 주면 된다. 
		 */
